...
describe('application tests', () => {
  ...
  it('should render name: Shubhayan Ghosh', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^Shubhayan Ghosh$/, undefined, true);
  });
  ...
  it('should render link to source code', () => {
    ...
    checkContent(
      element,
      /^Source$/,
      'https://github.com/Shubhayang6/Shubhayan_Ghosh_portfolio',
    );
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/Shubhayang6/');
  });
...
describe('app context tests', () => {
  it('should render partial footer on mobile', async () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Shubhayan Ghosh$/);
